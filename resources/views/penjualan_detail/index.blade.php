...
<script>
    ...
    $(function () {
        ...
        $('.btn-simpan').on('click', function (e) {
            ...
            $('.form-penjualan').submit(); // Kirim formulir jika validasi lolos
        });
    });
    ...
    function tambahProduk() {
        ...
        // Lakukan pengecekan stok sebelum menambah produk
        $.get(`{{ url('/produk/checkstok') }}/${id_produk}`)
            .done(response => {
                if (response.stok <= 0) {
                    alert('Stok produk ini habis dan tidak bisa ditambahkan.');
                    return;
                }

                // Lanjutkan proses penambahan produk jika stok mencukupi
            ...
            .fail(errors => {
                alert('Tidak dapat memeriksa stok produk');
                return;
            });
    }
